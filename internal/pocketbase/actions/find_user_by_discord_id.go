...
func FindUserByDiscordID(app *pocketbase.PocketBase, discordID string) (*core.Record, error) {
	record, err := app.FindFirstRecordByFilter("users", "discordId = {:id}", dbx.Params{"id": discordID})
